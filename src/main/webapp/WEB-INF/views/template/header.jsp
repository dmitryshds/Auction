        							...
        							<nav id="top-navigation" class="col-lg-7 col-md-7 col-sm-7">
        								<ul class="pull-left">
											<sec:authorize access="isAuthenticated()">
        									 	<li><a href="account" methods="GET">My Account</a></li>
        									</sec:authorize>
        							...
        							<nav class="col-lg-5 col-md-5 col-sm-5">
        								<ul class="pull-right">
											<sec:authorize access="!isAuthenticated()">
        										<li class="purple">
													<a href="login">
														<i class="icons icon-user-3"></i> Login</a>
        									    </li>
        									<li><a href="register">
											...
											<sec:authorize access="isAuthenticated()">
												<li class="purple">
													    	<i class="icons icon-user-3"> Hello <sec:authentication property="principal.username" /></i>
												<li><a href="/logout">
                                                    	...
                                                    	<div class="box-wrapper no-padding parent-border">
                                                            <table class="language-table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="country"><a href="#">Russian</a></td>
                                                                </tr>
                                                            </table>
                                                        </div>
        											</li>
